...
public class Const {
    ...
    public class ServiceType {
        ...
        public static final  String ORDERS =FOODAPI+"order";
        public static final  String PONINT_NIMIGAME =FOODAPI+"minigame/point";
        public static final String PAYMENT = FOODAPI+"payment?id=";
    ...
    public class ServiceCode {
        ...
        public static final int GETSADVER = 55;
        //provider
