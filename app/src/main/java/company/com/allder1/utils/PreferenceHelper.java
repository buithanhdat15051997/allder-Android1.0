...
public class PreferenceHelper {
    ...
    private final String GEDER = "geder";
    ...
    private final String NAME = "first_name";
    ...
    public String getLat() {
        return app_prefs.getString(Lat, "");
    }
    public void putGeder(String geder) {
        Editor edit = app_prefs.edit();
        edit.putString(GEDER, geder);
        edit.commit();
    }

    public String getGeder() {
        return app_prefs.getString(GEDER, "");
    }
    public void putLong(String Long1) {
        Editor edit = app_prefs.edit();
        edit.putString(Long,Long1);
        edit.commit();
    }

    public String getLong() {
        return app_prefs.getString(Long, "");
    }
    public void putSpecies(String name) {
        Editor edit = app_prefs.edit();
        edit.putString(species, name);
        edit.commit();
    }

    public String getSpecies() {
        return app_prefs.getString(species, "");
    }
    ...
    public void putUser_name(String firstname) {
        Editor edit = app_prefs.edit();
