...
public class RecommendationAdapter extends RecyclerView.Adapter<RecommendationAdapter.ViewHolder> {
    ...
    public RecommendationAdapter(Context mcontext, ArrayList<RecommendationFood> listRecommendationFood) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View itemview = layoutInflater.inflate(R.layout.item_recommendation, viewGroup, false);
    ...
    public int getItemCount() {
        return listRecommendationFood.size();
    }
...
//    public void  AddlistRecommenAdapter( ArrayList<RecommendationFood> addlistRecommendationFood){
//        listRecommendationFood.addAll(addlistRecommendationFood);
